...
> المرحلتان ١ و٢ (التدقيق والمعمارية) مكتملتان. طبقة القاعدة (070–080) مكتوبة والواجهة مبنيّة. **الهجرات لم تُشغَّل بعد على القاعدة الحيّة.**
...
| البند | السبب / الحالة |
|---|---|
| **تشغيل الهجرات 070–080 على القاعدة** | ⚠️ لم تُشغَّل. القاعدة الحيّة على 069. كل ما فوق واجهة على فراغ حتى تُشغَّل |
...
|---|---|---|
| هجرات SQL | ١١ ملفاً · ٥٨٧٤ سطر | التشغيل |
