    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="space-y-8 p-6">
        ...
        <p className="-mt-4 mb-4 text-sm text-gray-500">
          ...
          و<b>الموارد البشرية</b> و<b>المحاسب</b> يقتسمان شؤون المال والأفراد
          قسمةً متعمَّدة: الموارد البشرية <b>تُحضّر</b> — ملفّات الموظفين
          والدوام والإجازات والسلف وبناء كشوف الرواتب — والمحاسب{" "}
          <b>يُرحّل ويدفع</b>: يعتمد الكشف فيدخل الدفاتر، ويقفل الفترة
          المحاسبية، ويحصّل عمولة الشركة، ويصرف السلفة. فمن يبني الرقم لا
          يوقّعه، ومن يوقّعه لا يبنيه. ولا أحد منهما يغيّر الأدوار من هذه
          الصفحة — تبقى لك وحدك. و<b>المشرف</b> موظف نطاقه مشروعه: يرى ليدات فريقه ومتابعاتهم وحضورهم
          ...
          الموظفين والاتصالات والمهام، و<b>تسجيل الاستقطاعات</b> على الموظفين
          (تُحتسب في كشف الراتب القادم ويصلك إشعار بكل خصم) — وتبقى المحاسبة
          والفواتير والرواتب والموافقة على الإجازات خارج نطاقه.
          و<b>مدير العلاقات</b> يتابع الشركات الوسيطة التي تحت مظلته في مشروعه:
          ليداتها ومهلها وعمولاتها — بلا صلاحية إسناد أو صرف. و<b>الموظف</b> يرى
          عملاءه هو فقط. أما <b>الشركات الوسيطة</b> فحساباتها تُربط من{" "}
          <Link href="/dashboard/brokers" className="font-semibold underline">
            صفحة الوساطة
          </Link>{" "}
          لا من هنا. إسناد الموظفين للمشاريع من{" "}
